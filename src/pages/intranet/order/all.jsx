...
import {
  TYPES_ORDERS,
  ordersInitialReducer,
  reducerOrders,
} from "@/reducers/crudOrders";
...
function OrderAll({ dataUser, dataModules, dataRoles }) {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        sweetAlert({
          title: "Error",
          text: "Error al obtener de clientes y departamentos",
          icon: "error",
        });
      }
    };
  ...
  return (
    <>
      ...
      <FormOrder
        statusModal={modal}
        quotationsNew={state.quotationsNew}
        departaments={departaments}
        districsAll={state.districs}
        provincesAll={state.provinces}
        customers={filters.customers}
        orderEdit={state.orderEdit}
        quotationsEdit={state.quotationsEdit}
