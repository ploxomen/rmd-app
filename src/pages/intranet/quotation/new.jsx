...
function quotationNew({ dataUser, dataModules, dataRoles }) {
        ...
        if (existProduct) {
            ...
            setProducts([
                ...products,
                {
                    ...
                    quantity: 1,
                    price_unit: e.product_public_customer,
    ...
    const handleTypeAmmountChange = (value, productId) => {
        setProducts(products.map(product => product.id == productId ? { ...product, type_ammount: value, price_unit: (value == "P. P. Cliente" ? product.price_public_customer : product.price_distributor) } : product))
    }
