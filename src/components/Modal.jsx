...
function Modal({
  ...
  return (
    <div
      className="fixed z-20 top-0 left-0 w-full h-dvh bg-modal"
      hidden={status}
    >
      <div className="px-4 py-6 w-full h-full flex justify-center items-start overflow-y-auto">
        <div
          className={`py-4 px-6 border border-gray-300 w-full bg-white ${maxWidth} rounded-lg`}
        >
          ...
          <div className="text-end flex gap-2 items-center justify-end">
            ...
            <button
              className="p-2 bg-rose-500 rounded-md transition-colors hover:bg-rose-400 focus:bg-rose-600 text-white font-semibold text-sm"
