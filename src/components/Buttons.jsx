export function ButtonPrimary({ type = "button", text, icon, onClick }) {
  return (
    <button
      className="rounded-md overflow-hidden relative inline-flex group items-center justify-center px-3.5 py-2 m-1 cursor-pointer border-b-4 border-l-2 hover:bg-green-600 font-semibold transition-all ease-in-out shadow-lg bg-gradient-to-tr bg-green-500 text-white"
      type={type}
      onClick={onClick}
    >
...
export function ButtonSecondarySm({
  type = "button",
  text,
  onClick,
  icon,
...
export function ButtonDangerSm({
  type = "button",
  text = null,
  onClick,
  icon,
  ...
  return (
    <button
      className="rounded-md relative overflow-hidden inline-flex group items-center justify-center px-2 py-1.5 cursor-pointer border-b-4 border-l-2 hover:bg-red-600 font-semibold transition-all ease-in-out text-xs shadow-lg bg-gradient-to-tr bg-red-500 text-white"
      type={type}
      onClick={onClick}
      {...props}
    >
