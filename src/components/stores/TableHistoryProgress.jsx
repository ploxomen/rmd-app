...
export default function TableHistoryProgress({
  histories,
  deleteHistory,
  viewHistory,
}) {
      ...
      {!histories.length ? (
        ...
        histories.map((history) => (
          <tr className="bg-white dark:bg-gray-800 text-xs" key={history.id}>
            ...
            <td className="p-1 text-center">
              {history.product_progress_history_date}
            </td>
            <td className="p-1 text-center">{history.product_name}</td>
            <td className="p-1 text-center">
              {history.product_progress_history_stock}
            </td>
            <td className="p-1 text-center">
              {history.product_progress_history_description}
            </td>
            <td className="p-1">
